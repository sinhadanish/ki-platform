...
```typescript
// ✅ Good: Privacy-separated partner data
...
// ❌ Bad: Mixed partner data without consent
...
```python
# ✅ Good: Empathetic, non-judgmental AI responses
...
# ❌ Bad: Judgmental or clinical responses  
